...
public class SingleQpidByteBuffer implements org.apache.qpid.server.bytebuffer.QpidByteBuffer
{
    ...
    {
        final org.apache.qpid.server.bytebuffer.QpidByteBuffer buffer = this;
    ...
    @Override
    public final SingleQpidByteBuffer put(final org.apache.qpid.server.bytebuffer.QpidByteBuffer src)
    {
    ...
    {
        return _ref.isSparse(org.apache.qpid.server.bytebuffer.QpidByteBufferFactory.getSparsityFraction());
    }
}
