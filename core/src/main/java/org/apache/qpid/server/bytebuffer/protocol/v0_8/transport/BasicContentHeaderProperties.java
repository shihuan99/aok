 ...
 *
 */
package org.apache.qpid.server.bytebuffer.protocol.v0_8.transport;
...
public class BasicContentHeaderProperties
{
    ...
    public BasicContentHeaderProperties(QpidByteBuffer buffer, int propertyFlags, int size) throws AMQFrameDecodingException
    {
        ...
        /* DMS modify start: don't save buffer view in _encodedForm */
        try (QpidByteBuffer byteBuffer = buffer.view(0, size))
        {
            /* DMS modify end */
            decode(byteBuffer);
        }
